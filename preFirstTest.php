...
<?php getHeader();?>
    ...
    <div class="content" style='width:80%; margin:unset'>
       <h2 style="text-align: center;font-size: 30px; color: red;margin-bottom: 20px;font-family: 'Montserrat', sans-serif;">English Proficiency Test</h2>
       <p class="prepare">Hello <?php echo $_SESSION['name']; ?></p>
       <p class="prepare">To evaluate your ability exactly. We prepare for you a proficiency test</p>
       <p class="prepare">Thank you for your attention!</p>
       <a class="prepare" href="/firstTest.php">Join it</a>
